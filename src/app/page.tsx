    ...
    <div className="flex flex-col overflow-hidden relative">
      ...
      <main className="">
        ...
        <section className="flex flex-col pt-24 max-xl:pt-20 bg-[url(/pngs/heroBg.png)] max-md:bg-[url(/pngs/mobileHeroBg.png)] bg-no-repeat bg-cover max-md:bg-contain">
          ...
          <div
            ref={heroBanner}
            className="banner py-md px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-sm:px-5"
            style={{ visibility: "hidden", opacity: 0 }}
          >
            <div className="flex py-[0.625rem] px-[0.94rem] rounded-xl bg-[#00f6ffde]">
          ...
          {/* Hero Content */}
          <div className="flex max-md:flex-col max-md:pt-10 max-md:pb-20 items-center justify-between gap-2xl max-lg:gap-xs px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-md:gap-md max-sm:px-5">
            {/* Hero Texts */}
            <div
              ref={heroTextRef}
              className="hero-text flex flex-col gap-md will-change-[transform,opacity]"
            ...
            <div
              ref={phoneVideoRef}
              className="max-md:w-full px-xl max-lg:px-0 max-md:px-0 will-change-[transform,opacity]"
              style={{ opacity: 0, visibility: "hidden" }}
            >
        ...
        {/* New Era section */}
        <section className="px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-sm:px-5 pt-[3.75rem] pb-20 max-md:pt-0 flex max-md:flex-col gap-[3.125rem] max-md:gap-[0.55rem] items-center">
          {/* Image */}
          ...
          <div className="flex gap-[0.9375rem] flex-col slide-left">
            ...
            <ScrollAnimation type="zoomIn">
              <ul
                className={`${openSans.className} text-[#8CA0B3] text-base list-disc pl-6`}
              >
                <li>
        ...
        {/* New Era section */}
        <section className="px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-sm:px-5 pt-[3.75rem] pb-20 max-md:pt-0 flex max-md:flex-col-reverse gap-[3.125rem] max-md:gap-[0.75rem] items-center">
          {/* Texts */}
        ...
        <section className="px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-sm:px-5 pt-[3.75rem] pb-20 max-md:pt-0 flex flex-col gap-md ">
          ...
          <div className="grid grid-cols-[1.5fr_1fr] gap-md max-md:grid-cols-1 max-md:gap-20">
            {/* Info */}
        ...
        {/* Coming soon section */}
        <ScrollAnimation type="zoomIn">
          <section className="px-7xl max-3xl:px-6xl max-2xl:px-5xl max-xl:px-10 max-sm:px-5 pt-20 pb-[7.5rem] max-md:pb-[5rem] max-md:pt-[3.75rem] max-sm:mx-5 mb-[1.88rem] flex flex-col gap-[0.94rem] bg-[linear-gradient(115deg,#1870f6_62.27%,#32fefe_95.1%)]">
            <ScrollAnimation type="zoomIn">
              <h1 className="text-7xl max-md:text-5xl max-sm:text-4xl">
                Coming Q1 2025
              </h1>
            </ScrollAnimation>
            <ScrollAnimation type="fadeDown">
